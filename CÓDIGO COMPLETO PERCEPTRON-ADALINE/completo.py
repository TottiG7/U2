...
print(50 * '=')
print('Section: Training a perceptron model on the jugadores dataset')
print(50 * '-')
## AQUÍ VAN A TOMAR SUS DATOS DEL PROGRAMA ANTERIOR ##
df = pd.read_csv('jugadoresfutbol.csv', header=0, encoding='ISO-8859-1')
print(df.tail())

#############################################################################
print(50 * '=')
print('Plotting the jugadores data')
print(50 * '-')

# select España and Italia
y = df.iloc[0:100, 4].values
y = np.where(y == 'jugadores', -1, 1)

# extract Promediogol and Edad
X = df.iloc[0:100, [1, 2]].values

# plot data   --- CLASIFICA POR EQUIPOS
plt.scatter(X[:50, 0], X[:50, 1],
            color='red', marker='o', label='España')
plt.scatter(X[50:100, 0], X[50:100, 1],
            color='blue', marker='x', label='Italia')

plt.xlabel('Promediogol')
plt.ylabel('Edad')
...
plt.xlabel('Promediogol [standardized]')
